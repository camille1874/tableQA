...
if __name__ == "__main__":
    ...
    #argparser.add_argument("--input", type=str, help="Input file", default="/home/geshi/nsm_allen/WikiTableQuestions/data/random-split-1-train-noaligned.examples")
    #argparser.add_argument("--input", type=str, help="Input file", default="/home/geshi/nsm_allen/WikiTableQuestions/data/random-split-1-train-with-lgfs.examples")
    argparser.add_argument("--tables_directory", type=str, help="Tables directory", default="/home/xuzh/1231/data/WikiTableQuestions/")
    argparser.add_argument("--archived_model", type=str, help="Archived model.tar.gz", default="/home/geshi/new_run/mml_1009_align_operator_merged/model.tar.gz")
