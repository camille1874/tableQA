...
# complex type,第一个是参数type，第二个是return type
...
# <r,<t,s>>
string_column_name_mapper.map_name_with_signature("select_string", SELECT_STRING_TYPE)
string_column_name_mapper.map_name_with_signature("mode_string", SELECT_STRING_TYPE)
