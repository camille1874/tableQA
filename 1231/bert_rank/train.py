...
import time
import datetime
from text_cnn_feature import TextCNN
from tensorflow.contrib import learn
from preprocess import Bert, MData
import sys

tf.flags.DEFINE_string("positive_data_file", "train_pos.txt", "Data source for the positive data.")
tf.flags.DEFINE_string("negative_data_file", "train_neg.txt", "Data source for the negative data.")
...
with tf.Graph().as_default():
    ...
    with sess.as_default():
        ...
        def train_step(x_batch, y_batch, features):
            feed_dict = {
              cnn.input_x: x_batch,
              cnn.input_y: y_batch,
              cnn.dropout_keep_prob: FLAGS.dropout_keep_prob,
              cnn.features: features
            }
        ...
        for e in range(FLAGS.num_epochs):
            ...
            while train_data.is_available():
                x_batch, y_batch, features_batch = train_data.next_batch(batch_size=FLAGS.batch_size)
