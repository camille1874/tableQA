...
# Data Parameters
tf.flags.DEFINE_string("final_x", "test_x.txt", "Data source for the positive data.")
tf.flags.DEFINE_string("final_y", "test_y.txt", "Data source for the negative data.")
