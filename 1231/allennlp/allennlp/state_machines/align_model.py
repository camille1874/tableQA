...
import time
import datetime
from allennlp.state_machines.preprocess import Word2Vec, MData
from allennlp.state_machines import data_helpers
from allennlp.state_machines.text_cnn_feature import TextCNN
...
class Classification(object):
    def __init__(self, batch_size=1, checkpoint_dir="/home/xuzh/new1/classification/runs/1575713157/checkpoints/"): 
    ...
    def get_score(self, question, table, lgf, predict_score, raw_align_score):
        ...
        return batch_scores[0][1] - batch_scores[0][0]
