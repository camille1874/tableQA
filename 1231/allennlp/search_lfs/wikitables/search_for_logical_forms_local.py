...
def search(tables_directory: str,
    ...
    # you can implement a lemma here to find the roots of tokens
...
table_directory = "/home/geshi/nsm_allen/WikiTableQuestions/"
data = "/home/geshi/nsm_allen/test_data/train.examples"
output_path = "/home/geshi/nsm_allen/tests"
max_path_length = 10
max_num_logical_forms = 100
use_agenda = True
...
search(table_directory,input_data,output_path,max_path_length,
       max_num_logical_forms,use_agenda,output_separate_files,conservative)

# if __name__ == "__main__":
#     parser = argparse.ArgumentParser()
#     parser.add_argument("--table_directory", type=str, default="/home/geshi/nsm_allen/WikiTableQuestions/",
#                         help="Location of the 'tagged' directory in the"
#                              "WikiTableQuestions dataset")
#     parser.add_argument("--data_file", type=str,
#                         default="/home/geshi/nsm_allen/WikiTableQuestions/data/training.examples",
#                         help="Path to the *.examples file")
#     parser.add_argument("--output_path", type=str, default="/home/geshi/nsm_allen/searched_lfs_with_rules_2", help="""Path to the output directory if
...
#                         train a parser.""")
#     parser.add_argument("--num-splits", dest="num_splits", type=int, default=15,
