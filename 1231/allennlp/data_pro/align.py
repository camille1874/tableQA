...
operator_trigger = {"select_string": None,
                    ...
                    "count": ["how many"],
                    "max_number": ["what is the most"],
                    "min_number": ["what is the least"],
                    "max_date": ["last"],
                    "min_date": ["first"],
                    "sum": ['total'],
                    "average": ["average"],
...
new_dir = "/home/geshi/nsm_allen/lgfs_align_operator_column/"
input_examples_file = "/home/geshi/nsm_allen/WikiTableQuestions/data/training.examples"
table_path = "/home/geshi/nsm_allen/WikiTableQuestions/"
...
for lgs_path in os.listdir(lgs_dir):
    ...
    for logical_form in g_file:
        ...
        operator_flag = align_operator(operator_trigger, operator,
                                       data_examples[lgs_path.split('.')[0]]['question'])
        ...
        if line_idx <= LOGICAL_FORM_NUM and column_flag and operator_flag:
            new_lgs_lst.append(logical_form + "\n")
    if new_lgs_lst:
