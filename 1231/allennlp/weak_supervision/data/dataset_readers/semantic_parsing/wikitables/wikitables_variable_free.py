...
from allennlp.data.fields import (Field, TextField, MetadataField, ProductionRuleField,
                                  ListField, IndexField, KnowledgeGraphField, ArrayField)
...
class WikiTablesVariableFreeDatasetReader(DatasetReader):
    ...
    def __init__(self,
                 ...
                 keep_if_no_logical_forms: bool = True,
    ...
    def text_to_instance(self,  # type: ignore
        ...
        for tl in table_lines:
            tmp = []
            for tt in tl:
                tmp.append(MetadataField(tt))
            table_lines_field.append(ListField(tmp))
        fields['table_lines'] = ListField(table_lines_field)
        fields['question_lines'] = MetadataField(question)
        ...
        if offline_search_output:
            ...
            action_sequence_scores: List[Field] = []
            for logical_form in offline_search_output:
                if "|" in logical_form:
                    logical_form, score = logical_form.split("|")
                else:
                    score = 0
                try:
                ...
                try:
                    ...
                    action_sequence_scores.append(MetadataField(score))
            ...
            fields['target_action_scores'] = ListField(action_sequence_scores)
