    ...
    def _compute_validation_outputs(self,
        ...
        for i in range(batch_size):
            ...
            if i in best_final_states:
                ...
                self._has_logical_form(1.0 if glo_has_logical_form else 0.0)
                self._denotation_accuracy(1.0 if glo_accu else 0.0)
