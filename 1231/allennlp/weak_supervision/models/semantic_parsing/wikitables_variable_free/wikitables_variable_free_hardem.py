...
from weak_supervision.models.semantic_parsing.wikitables_variable_free.hard_em import HardEM
...
@Model.register("wikitables_variable_free_hardem")
class WikiTablesVariableHardEM(WikiTablesVariableFreeParser):
    """
    ...
    def __init__(self,
        ...
        self._decoder_trainer = HardEM(training_beam_size)
