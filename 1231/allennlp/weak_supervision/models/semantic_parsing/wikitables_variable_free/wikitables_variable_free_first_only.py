...
from weak_supervision.models.semantic_parsing.wikitables_variable_free.first_only import FirstOnly
...
@Model.register("wikitables_variable_free_firstonly")
class WikiTablesVariableFirstOnly(WikiTablesVariableFreeParser):
    """
    ...
    def __init__(self,
        ...
        self._decoder_trainer = FirstOnly(training_beam_size)
    ...
    def forward(self,  # type: ignore
        ...
        if self.training:
            ...
            return self._decoder_trainer.decode(initial_state,
                                                self._decoder_step,
                                                (target_action_sequences, target_mask), training=True)
        else:
            if target_action_sequences is not None:
