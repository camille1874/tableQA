...
@Model.register("wikitables_variable_free_mml")
class WikiTablesVariableFreeMml(WikiTablesVariableFreeParser):
    ...
    def __init__(self,
                 vocab: Vocabulary,
                 question_embedder: TextFieldEmbedder,
                 fixed_question_embedder: TextFieldEmbedder,
                 action_embedding_dim: int,
                 encoder: Seq2SeqEncoder,
                 entity_encoder: Seq2VecEncoder,
                 decoder_beam_search: BeamSearch,
        ...
        super().__init__(vocab=vocab,
                         ...
                         fixed_question_embedder=question_embedder,
    ...
    def forward(self,  # type: ignore
        ...
        rnn_state, grammar_state, fixed_embedded_ques = self._get_initial_rnn_and_grammar_state(question,
                                                                           table,
                                                                           world,
                                                                           actions,
                                                                           outputs)
        ...
        if self.training:
            return self._decoder_trainer.decode(initial_state,
                                                ...
                                                actions,
                                                world, 
                                                (target_action_sequences, target_mask), target_action_scores, fixed_embedded_ques)
        else:
            if target_action_sequences is not None:
                tmp = self._decoder_trainer.decode(initial_state, self._decoder_step, ques, kg, actions, world, (target_action_sequences, target_mask), target_action_scores, fixed_embedded_ques)
